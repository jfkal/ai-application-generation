package com.yuanfen.aiapplicationgeneration.generator;
...
public class MyBatisCodeGenerator {
    ...
    public static GlobalConfig createGlobalConfig() {
        ...
        globalConfig.getPackageConfig()
                .setBasePackage("com.yuanfen.aiapplicationgeneration.genresult");
        ...
        globalConfig.getJavadocConfig()
                .setAuthor("<a href=\"http://111.230.108.171/\">程序员缘分</a>")
                .setSince("");
        return globalConfig;
    }
}
